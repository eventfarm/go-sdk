...
type ListUsersForExhibitorParameters struct {
	ExhibitorId   string
	PoolId        string
...
func (t *User) ListUsersForExhibitor(p *ListUsersForExhibitorParameters) (r *http.Response, err error) {
	queryParameters := url.Values{}
	...
	return t.restClient.Get(
		`/v2/User/UseCase/ListUsersForExhibitor`,
		&queryParameters,
		nil,
		nil,
	)
